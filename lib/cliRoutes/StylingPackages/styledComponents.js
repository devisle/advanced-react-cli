  ...
  (0, _createClass2["default"])(StyledComponents, [{
    ...
    value: function install(packageInstaller) {
      switch (packageInstaller) {
        case 'NPM':
          customCMD.get("".concat(styledComponentsObj.install), 'install', 'Package: styled-components has been installed successfully!');
          break;

        case 'Yarn':
          customCMD.get("".concat(styledComponentsObjYarn.install), 'install', 'Package: styled-components has been installed successfully!');
          break;
      }
    }
  }, {
    ...
    value: function uninstall(packageInstaller) {
      switch (packageInstaller) {
        case 'NPM':
          customCMD.get("".concat(styledComponentsObj.uninstall), 'uninstall', 'Package: styled-components has been uninstalled successfully!');
          break;

        case 'Yarn':
          customCMD.get("".concat(styledComponentsObjYarn.uninstall), 'uninstall', 'Package: styled-components has been uninstalled successfully!');
          break;
      }
    }
  }]);
