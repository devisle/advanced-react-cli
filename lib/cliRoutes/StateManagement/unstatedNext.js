...
module.exports =
  ...
  (function () {
    function UnstatedNext () {
      _classCallCheck(this, UnstatedNext)
    }

    _createClass(UnstatedNext, [
      {
        ...
        value: function install (packageInstaller) {
          switch (packageInstaller) {
            case 'NPM':
              ...
              console.log(
                'Package: Unstated-next has been installed successfully!'
              )
              break

            case 'Yarn':
              customCMD.get(
                ''.concat(unstatedNextYarn.install),
                function (err, data, stderr) {
                  err ? console.log(err) : errorLogging(stderr, data)
                },
                'install'
      ...
      },
      {
        ...
        value: function uninstall (packageInstaller) {
          switch (packageInstaller) {
            ...
            case 'Yarn':
              customCMD.get(
                ''.concat(unstatedNextYarn.uninstall),
                function (err, data, stderr) {
                  err ? console.log(err) : errorLogging(stderr, data)
                },
                'uninstall'
