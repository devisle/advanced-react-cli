  ...
  (0, _createClass2["default"])(TypesNodes, [{
    ...
    value: function install(packageInstaller) {
      switch (packageInstaller) {
        case 'NPM':
          customCMD.get("".concat(typesNode.install), 'install', "Package(s): @types/node has been installed successfully!");
          break;

        case 'Yarn':
          customCMD.get("".concat(typesNodeYarn.install), 'install', "Package(s): @types/node has been installed successfully!");
          break;
      }
    }
  }, {
    ...
    value: function uninstall(packageInstaller) {
      switch (packageInstaller) {
        case 'NPM':
          customCMD.get("".concat(typesNode.uninstall), 'uninstall', "Package(s): @types/node has been uninstalled successfully!");
          break;

        case 'Yarn':
          customCMD.get("".concat(typesNodeYarn.uninstall), 'uninstall', "Package(s): @types/node has been uninstalled successfully!");
          break;
      }
    }
  }]);
