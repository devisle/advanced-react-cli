  ...
  (0, _createClass2["default"])(TypesReactRouter, [{
    ...
    value: function install(packageInstaller) {
      switch (packageInstaller) {
        case 'NPM':
          customCMD.get("".concat(typesReactRouter.install), 'install', 'Package(s): @types/react-router @types/react-router-dom have been installed successfully!');
          break;

        case 'Yarn':
          customCMD.get("".concat(typesReactRouterYarn.install), 'install', 'Package(s): @types/react-router @types/react-router-dom have been installed successfully!');
          break;
      }
    }
  }, {
    ...
    value: function uninstall(packageInstaller) {
      switch (packageInstaller) {
        case 'NPM':
          customCMD.get("".concat(typesReactRouter.uninstall), 'uninstall', 'Package(s): @types/react-router @types/react-router-dom have been uninstalled successfully!');
          break;

        case 'Yarn':
          customCMD.get("".concat(typesReactRouterYarn.uninstall), 'uninstall', 'Package(s): @types/react-router @types/react-router-dom have been uninstalled successfully!');
          break;
      }
    }
  }]);
