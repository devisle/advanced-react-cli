...
const inquirer = require('inquirer') // CLI Model

const cliModel = require('../../cliModel') // const addPackage = cliModel.addPackage

const TypeScriptPackages = cliModel.typescriptPackages
const YarnOrNpm = cliModel.YarnOrNpm // TypeScript & @types imports
