...
function () {
  ...
  (0, _createClass2["default"])(CustomInstall, [{
    ...
    value: function prompt(packageInstaller) {
      var addTypeScriptNPM, addTypesNodeNPM, addTypesReactNPM, addTypesReactRouterNPM, addTypesReactReduxNPM, addTypesJestNPM, addTypeScriptYarn, addTypesNodeYarn, addTypesReactYarn, addTypesReactRouterYarn, addTypesReactReduxYarn, addTypesJestYarn;
      /*
          Prompts to install TypeScript
        */

      _prompt(_objectSpread({}, addPackage[0], {
          ...
          _prompt(_objectSpread({}, addPackage[0], {
            ...
            */
            ...
            _prompt(_objectSpread({}, addPackage[0], {
              ...
              if (['y', 'yes'].includes(packageAdd.toLowerCase())) {
                addTypesReactRouterNPM = '@types/react-router @types/react-router-dom';
                addTypesReactRouterYarn = '@types/react-router @types/react-router-dom';
              } else if (['n', 'no'].includes(packageAdd.toLowerCase())) {
                ...
                */
                ...
                _prompt(_objectSpread({}, addPackage[0], {
                  ...
                  switch (packageInstaller) {
                    case 'NPM':
                      customCMD.get(" npm install --save ".concat(addTypeScriptNPM, " ").concat(addTypesNodeNPM, " ").concat(addTypesReactNPM, " ").concat(addTypesReactRouterNPM, " ").concat(addTypesReactReduxNPM, " ").concat(addTypesJestNPM), 'install', "Package: ".concat(addTypeScriptNPM, " ").concat(addTypesNodeNPM, " ").concat(addTypesReactNPM, " ").concat(addTypesReactRouterNPM, " ").concat(addTypesReactReduxNPM, " ").concat(addTypesJestNPM, " has been installed successfully!"));
                      break;

                    case 'Yarn':
                      customCMD.get("yarn add ".concat(addTypeScriptYarn, " ").concat(addTypesNodeYarn, " ").concat(addTypesReactYarn, " ").concat(addTypesReactRouterYarn, " ").concat(addTypesReactReduxYarn, " ").concat(addTypesJestYarn), 'install', "Package: ".concat(addTypeScriptNPM, " ").concat(addTypesNodeNPM, " ").concat(addTypesReactNPM, " ").concat(addTypesReactRouterNPM, " ").concat(addTypesReactReduxNPM, " ").concat(addTypesJestNPM, " has been installed successfully!"));
                  }
                });
              });
            });
